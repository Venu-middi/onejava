...
<head>
  ...
  <title>NexusShop · Lavender Edition</title>
  <!-- Fonts & Icons -->
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    body {
      ...
      background: #f8f6fc; /* soft lavender background */
      color: #1a1a2e;
      line-height: 1.5;
    ...
    /* ----- variables (lavender palette) ----- */
    :root {
      --bg: #f8f6fc;
      --card: #ffffff;
      --primary: #2a1b3d;        /* deep lavender */
      --primary-light: #3f2a5a;
      --accent: #9b7bb8;         /* lavender main */
      --accent-light: #d9c9ed;   /* pale lavender */
      --accent-dark: #7a5a9e;    /* deeper lavender */
      --muted: #5e4e6b;
      --muted-light: #a892b5;
      --surface: #ede6f5;
      --shadow: 0 4px 20px rgba(42, 27, 61, 0.06);
      --shadow-hover: 0 12px 40px rgba(42, 27, 61, 0.10);
      --radius: 16px;
      --radius-sm: 10px;
      --transition: 0.2s cubic-bezier(0.4,0,0.2,1);
      --container: 1240px;
      --success: #6b8f71;        /* soft sage */
      --warning: #e8d5a5;        /* warm cream */
    }
    ...
    .btn-primary:hover { background: var(--accent-dark); border-color: var(--accent-dark); transform: translateY(-2px); box-shadow: 0 8px 20px rgba(155, 123, 184, 0.35); }
    ...
    .btn-outline { background: transparent; color: var(--primary); border-color: rgba(42, 27, 61, 0.15); }
    ...
    .search-wrap:focus-within { border-color: var(--accent); background: #fff; box-shadow: 0 0 0 4px rgba(155, 123, 184, 0.12); }
    .search-wrap input {
    ...
    #mobileMenu {
      display: none; background: #fff; border-top: 1px solid rgba(42, 27, 61, 0.06);
      padding: 12px 0 20px;
    }
    ...
    /* ----- hero (welcoming, lavender tint) ----- */
    .hero {
      position: relative; display: flex; align-items: center;
      min-height: 440px; padding: 48px 0;
      border-radius: var(--radius); overflow: hidden;
      margin: 16px 20px 0;
      background: linear-gradient(145deg, #2a1b3d 0%, #4a2d6a 100%);
    }
    .hero::before {
    ...
    .hero .badge {
      display: inline-block; background: rgba(155, 123, 184, 0.25); color: var(--accent-light);
    ...
    .hero p {
      color: rgba(255,255,255,0.85); font-size: 17px; max-width: 500px;
    ...
    .section-header .title-group h2 { font-size: 28px; font-weight: 700; letter-spacing: -0.2px; color: var(--primary); }
    ...
    .product-card .body h5 { font-size: 15px; font-weight: 600; line-height: 1.3; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; color: var(--primary); }
    ...
    .product-card .body .rating { display: flex; align-items: center; gap: 4px; font-size: 13px; color: #d4a373; }
    ...
    .deal-wrap .deal-content h3 { font-size: 28px; font-weight: 700; margin-bottom: 6px; color: var(--primary); }
    ...
    .testimonial-card .stars { color: #d4a373; font-size: 16px; letter-spacing: 2px; margin-bottom: 10px; }
    ...
    .testimonial-card .author .name { font-weight: 600; font-size: 14px; color: var(--primary); }
    ...
    /* footer */
    footer { margin-top: 16px; padding: 40px 0 24px; border-top: 1px solid rgba(42, 27, 61, 0.06); }
    ...
    .footer-bottom { text-align: center; padding-top: 20px; border-top: 1px solid rgba(42, 27, 61, 0.06); color: var(--muted-light); font-size: 13px; }
...
<body>
  ...
  <script>
    // ----- data (friendly and approachable) -----
    const CATEGORIES = [
    ...
    // ----- render functions (clear, friendly) -----
    ...
    newsletterForm.addEventListener('submit', (e) => {
      ...
      newsletterMsg.style.color = '#c9e4c5';
      newsletterMsg.style.display = 'block';
    ...
    console.log('✨ NexusShop · Lavender edition loaded.');
  </script>
</body>
</html>
